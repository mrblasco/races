...
\(V_2< V_1\), the sum of which we normalize to one. Let \(\bar{t}>0\)
denote a given deadline and \(\underline{y}\geq 0\) a (possibly
positive) required minimum quality level. A player's probability of
winning the \(k^{th}\) prize is given by the function
