...
The field experiment was conducted between March 2 and 16, 2016. The context of the experiment was an online programming contest where participants compete writing a programming code that solves a designated problem. Similar programming contests are quite common and either as a tournament or a race competition.
...
tab <- table(dat$treatment, dat$room_type)
...
stargazer(dat[, select], header=FALSE, title='Descriptive statistics', align=TRUE, covariate.labels=names(select), digits=1)
