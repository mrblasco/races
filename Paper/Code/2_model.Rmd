...
To simplify the analysis, we suppose there are only two prizes of total value normalized to one. We let $\alpha$ denote the fraction going to the competitor placed first which is larger than fraction going to the second ($\alpha\geq1/2$).
