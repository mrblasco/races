# Experimental design
While many observational studies have examined behavior in contests, the design of observational studies for comparing races and tournaments can be problematic.  As our simple theoretical model indicates, contest designers will adopt competition styles that best suit their preferences for time and quality and, as a result, contestants are likely to face sensible payoff differences between a race and a tournament competition. These elements will create selection problems that are hard to control in purely observational studies.
