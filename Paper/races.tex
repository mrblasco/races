...
and probability of a succesfull innovation while minimizing the time it
takes to complete the project. Striking a balance between these two
desirable but incompatible features is often difficult. Although there
are many different aspects of contest design to consider, one key factor
is the choice of grounding the competition of the timing of the
innovation, or not. In general, there are two extreme forms of
competitions. One is the \emph{race} where the first to finish the
innovation project wins. So, the timing of innovation matters for
payoffs. The second is the \emph{tournament} where the best to finish
the project within a given unit of time wins, and the timing of
